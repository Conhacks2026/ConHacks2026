...
export default function SearchSystem() {
  ...
  return (
    <section className={`min-h-screen flex flex-col items-center justify-center pointer-events-auto px-4 z-20 relative transition-transform duration-1000 ${selectedLocation ? 'md:-translate-x-1/4' : ''}`}>
      <motion.div 
